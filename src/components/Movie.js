...
class Movie extends Component {
  constructor() {
    super();
    this.state = { isClicked: true, movie: "" };
  }
  componentDidMount() {
  ...
  addWatchlist = () => {
    ...
    this.props.addMovieInWatchlist(
      this.props.user.id,
      this.state.movie,
      this.props.token
    );
  ...
  removeWatchlist = () => {
    ...
    this.props.removeMovieInWatchlist(
      this.props.user.id,
      this.state.movie,
      this.props.token
    );
          ...
          <div className="row movie-content-moviepage">
            ...
            <div className="col-8 description-moviepage">
              <div className="title-watchlist-moviepage">
                <div>
                  ...
                  {this.props.token && this.state.isAdded === 0 && (
                    <button
                      className="watchlist-btn-moviepage btn-success btn m-1"
                ...
                {this.state.movie.rating > 0 && (
                  <button className="rating-moviepage">
              ...
              <div className="description-genre-moviepage">
                ...
                <p>
                  Release Date :{" "}
                  {this.state.movie.release_date&&this.state.movie.release_date.split("-").reverse().join("/")}
                </p>
              </div>
            </div>
          </div>
